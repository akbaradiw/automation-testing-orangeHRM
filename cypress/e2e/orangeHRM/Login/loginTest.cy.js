...
describe("Login Feature", () => {
  ...
  it("Verify Failed Login with invalid credentials (wrong username and wrong password)", () => {
  ...
  it("Verify Failed Login with invalid credentials (wrong username and valid password)", () => {
  ...
  it("Verify Failed Login with invalid credentials (valid username and wrong password)", () => {
    LoginPom.inputUsername().type("Admin");
  ...
  it("Verify Failed Login with empty username & empty password", () => {
    LoginPom.loginButton().click();
    LoginPom.requiredField();

  });

  it("Verify Failed Login with valid username & empty password", () => {
    LoginPom.inputUsername().type("Admin");
    LoginPom.loginButton().click();
    LoginPom.requiredField();
  ...
  it("Verify Failed Login with empty username & valid password", () => {
    LoginPom.inputPassword().type("admin123")
    LoginPom.loginButton().click();
    LoginPom.requiredField();
  ...
  it("Verify Failed Login with invalid username & empty password", () => {
  ...
  it("Verify Failed Login with empty username & invalid password", () => {
